...
dataframe = pd.read_csv('/Users/manraj/Documents/GitHub/coswara/combinedScriptData.csv')
...
for category in audio_categories:
    ...
    audio_csv_files = glob.glob(f'/Users/manraj/Documents/GitHub/coswara/Extracted_Audio_CSV/audio_{category}_data.csv')
...
annotations_csv_files = glob.glob('/Users/manraj/Documents/GitHub/coswara/annotations/*.csv')
...
dataframe.to_csv('combined_audio_data_final_annotation.csv', index=True)
print("Final DataFrame saved to 'combined_audio_data_final_annotation.csv'")
