...
for category, audio_file in audio_categories.items():
    ...
    audio_files = glob.glob(f'/Users/manraj/Desktop/Coswara-Data/Extracted_data/202*/*/{audio_file}')
    ...
    category_df.to_csv(f'/Users/manraj/Desktop/Coswara-Data/Extracted_Audio_CSV/audio_{category}_data.csv', index=False)
